...
const newArray = instructors.filter(
  (teacher) =>
    ["all", "weekend"].includes(teacher.availability) &&
    teacher.specialities.includes("Javascript")
);
...
for (let i = 0; i < newArray.length; i++) {
  console.log(
    `Hi ${newArray[i].name},we inform you that this weekend you will be doing the support class`
  );
}
// PART 3
...
for (let i = 0; i < newArray.length; i++) {
  if (newArray[i].specialities.includes("Python")) {
    console.log(
      `Hi ${newArray[i].name}, we inform you that this weekend you will be doing the support class and you need to prepare a Python workshop`
    );
  } else {
    console.log(
      `Hi ${newArray[i].name},we inform you that this weekend you will be doing the support class`
